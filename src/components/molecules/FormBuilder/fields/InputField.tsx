  ...
  return (
    <div className={`mb-4 ${width} ${className}`}>
      ...
      <input
        ...
        onKeyDown={onKeyDown}
        className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primarycolor !text-bgblack dark:bg-black dark:border-darkbordercolor1 dark:!text-white disabled:opacity-50 disabled:cursor-not-allowed"
      />
      {fieldError && (
