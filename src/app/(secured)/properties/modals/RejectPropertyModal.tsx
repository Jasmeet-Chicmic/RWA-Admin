...
const RejectPropertyModal = ({
  ...
  const handleConfirm = () => {
    startTransition(async () => {
      try {
        const res = await rejectPropertyAction(propertyId, {
          reason: reason.trim(),
          documents,
        });
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-bgwhite dark:bg-darkbgprimary w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden border border-bordergray200 dark:border-darkbordercolor1">
        {/* Header */}
        <div className="px-6 py-4 border-b border-bordergray200 dark:border-darkbordercolor1 flex items-center justify-between bg-red-50/50 dark:bg-red-500/5">
        ...
        <div className="p-6 space-y-5 custom-scrollbar max-h-[70vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-24 p-3 rounded-xl border border-bordergray200 dark:border-darkbordercolor1 bg-bgwhite dark:bg-darkbgbase text-sm focus:outline-none focus:ring-2 focus:ring-red-500/50 transition-all resize-none dark:text-white"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none pl-4 pr-10 py-2.5 bg-gray-50 dark:bg-white/5 border border-bordergray200 dark:border-darkbordercolor1 rounded-xl text-sm font-medium text-bgblack dark:text-white focus:outline-none focus:ring-2 focus:ring-red-500/50 transition-all cursor-pointer"
                >
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all duration-200 ${
                isDragActive
                  ...
                  : "border-bordergray200 dark:border-darkbordercolor1 hover:border-red-500/50 hover:bg-gray-50 dark:hover:bg-white/5"
              }`}
            >
              <input {...getInputProps()} />
              <div className="flex flex-col items-center gap-2">
                <div className="p-3 bg-red-50 dark:bg-red-500/10 rounded-full text-red-600">
                  <Upload size={24} />
                </div>
                <div>
